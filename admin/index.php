...
header('Content-Security-Policy: default-src \'self\'; script-src \'self\' https://cdn.jsdelivr.net https://unpkg.com \'unsafe-inline\'; style-src \'self\' https://fonts.googleapis.com https://unpkg.com \'unsafe-inline\'; font-src \'self\' https://fonts.gstatic.com data:; img-src \'self\' data: https: blob:; connect-src \'self\'; frame-ancestors \'self\'; base-uri \'self\'; form-action \'self\'');
